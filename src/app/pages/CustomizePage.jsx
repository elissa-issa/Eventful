  ...
  return (
    <Stack spacing={1.2}>
      <Stack direction="row" alignItems="center" justifyContent="space-between">
        ...
        <Typography sx={{ color: COLORS.primary, fontSize: '1.9rem', fontWeight: 800, lineHeight: 1 }}>
          -
        </Typography>
      </Stack>
...
function TopPickTile({ item, onClick }) {
  ...
  return (
    <Box component="button" type="button" onClick={onClick} sx={{ p: 0, border: 0, background: 'transparent', textAlign: 'left', cursor: 'pointer' }}>
      <Box
        component="img"
        src={item.imageSrc}
        alt={item.imageAlt}
