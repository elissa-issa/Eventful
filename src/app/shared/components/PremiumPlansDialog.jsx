...
import { cancelPremium } from '../../services/auth'
  ...
  const handlePremiumAction = async () => {
    ...
    if (isPremiumUser) {
      ...
      try {
        ...
        showToast('Premium plan cancelled successfully')
        onClose?.()
      } catch (error) {
        showToast(error.message || 'Could not cancel premium plan', 'error')
      } finally {
              ...
              {PLAN_OPTIONS.map((plan) => (
                ...
                >
                  ...
                  <Button
                    ...
                    disabled={plan.highlighted && isCancelling}
                    onClick={plan.highlighted ? handlePremiumAction : onClose}
                    sx={{
                      borderRadius: 999,
                      py: 1.1,
                      textTransform: 'none',
