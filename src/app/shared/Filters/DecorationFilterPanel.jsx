...
function DecorationFilterPanel({ value, categories = [], onChange, onClearAll, onClose }) {
      ...
      <Stack spacing={3} sx={{ px: 2.25, py: 2.5 }}>
        <Stack direction="row" alignItems="center" justifyContent="space-between">
          ...
          <Stack direction="row" spacing={0.25} alignItems="center">
            ...
            <IconButton
              aria-label="Close decoration filters"
              onClick={onClose}
              size="small"
        ...
        <Stack spacing={1}>
          ...
          <Autocomplete
            ...
            renderTags={(selected, getTagProps) => {
              const visibleTags = selected.slice(0, 1)
...
export default DecorationFilterPanel
